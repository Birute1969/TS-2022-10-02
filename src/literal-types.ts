...
console.group('Literal types - užduotys');
{
  ...
  type Munich = 'Munich';
  type Dorsten = 'Dorsten';
  type Frankfurt = 'Frankfurt';
  type GermanyCity = Bernau | Hamburg | Munich | Dorsten | Frankfurt;
  ...
  type Buldog = 'Buldog';
  type Mops = 'Mops';
  type Breed = Doberman | Poodle | Dalmantin | Buldog | Mops;
  ...
  {
    const city1: GermanyCity = 'Bernau';
    const city2: GermanyCity = 'Dorsten';
